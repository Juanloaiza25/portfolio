        ...
        <section className="min-h-[calc(100vh-5rem)] flex items-center justify-center px-4 relative overflow-hidden border-b-4 border-black">
            ...
            <div className="relative z-10 text-center max-w-5xl">
                ...
                <div className="flex flex-col md:flex-row justify-center gap-6 reveal active">
                    <a href="#projects" className="bg-black text-white border-2 border-black px-10 py-5 text-xl font-bold shadow-hard hover:bg-neo-green hover:text-black hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all cursor-hover">
                        View Database
                    </a>
                    <a href="/Assets/Resume/Arham Resume.pdf" download="Arham_Resume.pdf" className="bg-neo-white text-black border-2 border-black px-10 py-5 text-xl font-bold shadow-hard hover:bg-neo-pink hover:text-black hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all cursor-hover flex items-center justify-center gap-2">
